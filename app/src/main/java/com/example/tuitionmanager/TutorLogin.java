...
public class TutorLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        respass = findViewById(R.id.forgetpass);
        home2=findViewById(R.id.back_home);
        ...
        respass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(TutorLogin.this,ForgetPassStudent.class);
        ...
        home2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(TutorLogin.this,studentOrteacher.class);
                startActivity(intent);
            ...
            mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(TutorLogin.this,""+task.getException(),Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void sendUsertoNextActivity() {
        Intent intent = new Intent(TutorLogin.this,AfterTutorLogin.class);
